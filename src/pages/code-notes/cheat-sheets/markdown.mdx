...
tabs: ['vi', 'bash', 'grep', 'Markdown', 'Kubernetes', 'Elasticsearch']keywords: 'markdown'
---
...
<AnchorLinks>
  ...
  <AnchorLink>Code and Syntax Highlighting</AnchorLink>
  <AnchorLink>Tables</AnchorLink>
  <AnchorLink>Blockquotes</AnchorLink>
  <AnchorLink>Inline HTML</AnchorLink>
  <AnchorLink>Horizontal Rule</AnchorLink>
  <AnchorLink>Line Breaks</AnchorLink>
  <AnchorLink>YouTube Videos</AnchorLink>
</AnchorLinks>
...
<pre lang="no-highlight">
  <code>
    ```javascript var s = "JavaScript syntax highlighting"; alert(s); ``` ```python s = "Python syntax highlighting"
    print s ``` ``` No language indicated, so no syntax highlighting. But let's throw in a &lt;b&gt;tag&lt;/b&gt;. ```
  </code>
</pre>
