            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
              <Card className="border-border bg-card/50 rounded-2xl border p-8 backdrop-blur-sm">
                <CardHeader className="space-y-4">
                  ...
                  <CardTitle className="font-outfit text-xl font-bold">Portfolio</CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card className="border-border bg-card/50 rounded-2xl border p-8 backdrop-blur-sm">
                <CardHeader className="space-y-4">
                  ...
                  <CardTitle className="font-outfit text-xl font-bold">Code Notes</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground mb-6">
              ...
              <Card className="border-border bg-card/50 rounded-2xl border p-8 backdrop-blur-sm">
                <CardHeader className="space-y-4">
                  ...
                  <CardTitle className="font-outfit text-xl font-bold">Education</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground mb-6">
