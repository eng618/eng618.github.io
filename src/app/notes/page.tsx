    ...
    <div className="w-full max-w-4xl px-4 py-12 lg:px-8 lg:py-16">
      <div className="mb-12">
        ...
        <p className="text-muted-foreground text-xl leading-relaxed">
          Welcome to my digital garden. This is a space where I cultivate ideas, document my learning journey, and share
          reflections on software engineering, leadership, and personal growth.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        ...
        <Card className="border-border/50 bg-card/50 backdrop-blur-sm">
          ...
          <CardContent className="text-muted-foreground space-y-4">
            <p>
              Use the sidebar to explore the file structure. I've organized these notes hierarchically to make it easier
