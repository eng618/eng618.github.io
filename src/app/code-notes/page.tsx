...
export default function CodeNotesIndexPage() {
  ...
  return (
    <>
      <MobileSubHeader notes={notes} basePath="/code-notes" showToc={false} />
      <div className="w-full max-w-4xl px-4 py-12 lg:px-8 lg:py-16">
        <div className="mb-12">
          ...
          <p className="text-muted-foreground text-xl leading-relaxed">
            A collection of highly technical notes, cheat sheets, and code snippets. This is my personal reference
            library for languages, frameworks, and system design patterns.
          </p>
        </div>
