...
- [Resetting local branch to match remote](#resetting-local-branch-to-match-remote)
- [Deleting a remote branch](#deleting-a-remote-branch)
- [Local branches](#local-branches)
- [Delete all local branches except main](#delete-all-local-branches-except-main)
- [References to remote branches](#references-to-remote-branches)
