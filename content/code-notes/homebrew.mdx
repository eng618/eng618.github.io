...
- [When trying to install using homebrew](#when-trying-to-install-using-homebrew)
- [Bundle](#bundle)
- [Housekeeping](#housekeeping)
- [Useful taps and packages](#useful-taps-and-packages)
...
- [Creating Brewfile](#creating-brewfile)
- [Installing from Brewfile](#installing-from-brewfile)
- [Resetting local environment](#resetting-local-environment)
