...
{/* For troubleshooting brew issues see [Homebrew](./homebrew) */}
...
```shell
####### Verify if bash_completion is installed #######
...
- Sublime Text 3: is a very customizable text editor with a largely supported development community.
  _For usage details see the internal [Sublime Text 3](../osx-sublime_text) notes page._

  <ExternalLink href="https://www.sublimetext.com/">Sublime Homepage</ExternalLink>
...
<ExternalLink href="https://robots.thoughtbot.com/using-rbenv-to-manage-rubies-and-gems">
